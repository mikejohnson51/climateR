...
`climateR` offers support for `sf`, `sfc`, and `bbox` objects. Here we are requesting wind velocity data for the dour corners region of the USA by bounding coordinates.
