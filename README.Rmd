...
1. A catalog of ` rnrow(catalog)` resources from over `r length(unique(catalog$id))` collections from `r length(unique(catalog$asset))` data providers/archives. See (`climateR::catalog`)
