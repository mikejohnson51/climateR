...
ax.set_axis_off()
plt.savefig("/man/figures/nc_shape.png")
plt.show()
```

```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/nc_shape.png")
```
...
# plt.tight_layout()
plt.savefig("/man/figures/nc_prism_data.png")
plt.show()
#################
# # Get the maximum and minimum values for both datasets
# vmin = min(p["tmin"].min(), p["tmax"].min())
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/nc_prism_data.png")
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/nc_tmin_tmax_gridmet.png")
```
...
hplot.set_titles("")
plt.savefig("/man/figures/harvey_pr_gridmet.png")
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/harvey_pr_gridmet.png")
```
...
# plt.savefig(f'img/ca_heatwave.png')
plt.savefig("/man/figures/florida_multi_model_maca.png")
plt.show()
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/florida_multi_model_maca.png")
```
...
plt.savefig("/man/figures/colorado_model_avg_maca.png")
# plt.savefig(f'img/ca_heatwave.png')
plt.show()
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/colorado_model_avg_maca.png")
```
...
# plt.savefig(f'img/ca_heatwave.png')
plt.savefig("/man/figures/michigan_random_maca.png")
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/michigan_random_maca.png")
```
...
plt.tight_layout()
plt.savefig("/man/figures/kenya_tc_chirps.png")
# Display the plots
plt.show()
# plt.close()
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/kenya_tc_chirps.png")
```
...
plt.tight_layout()
plt.savefig("/man/figures/point_timeseries_gridmet.png")
# show plot
plt.show()
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/point_timeseries_gridmet.png")
```
...
plt.savefig("/man/figures/future_points_maca.png", dpi = 600)
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/future_points_maca.png")
```
...
plt.savefig("../man/figures/terraclim_points_tmax.png",dpi = 600)
plt.show()
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/terraclim_points_tmax.png")
```
...
plt.tick_params(axis='y', labelsize=8)
# plt.ylabel('Degree K')
plt.savefig("/man/figures/terraclim_points_timeseries.png", dpi = 600)
plt.show()
# plt.close()
```
...
```{r echo=FALSE, out.width="100%", fig.align='center'}
# knitr::include_graphics("img/raster_data_model.png")
knitr::include_graphics("../man/figures/terraclim_points_timeseries.png")
```
